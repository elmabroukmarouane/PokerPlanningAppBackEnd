...
namespace PokerPlanningApp.Extensions.Add
{
    public static class AddServices
    {
        public static void AddSERVICES(this IServiceCollection self, IConfiguration configuration, IHostEnvironment hostEnvironment)
        {
            ...
            // self.AddTransient<IGenericQueryService<EntiteJuridique>, GenericQueryService<EntiteJuridique>>();
            // self.AddTransient<IGenericCommandService<EntiteJuridique>, GenericCommandService<EntiteJuridique>>();
            // self.AddTransient<IGenericQueryService<EntiteJuridiqueSecteurActivites>, GenericQueryService<EntiteJuridiqueSecteurActivites>>();
            // self.AddTransient<IGenericCommandService<EntiteJuridiqueSecteurActivites>, GenericCommandService<EntiteJuridiqueSecteurActivites>>();
            // self.AddTransient<IGenericQueryService<Referentiel>, GenericQueryService<Referentiel>>();
            // self.AddTransient<IGenericCommandService<Referentiel>, GenericCommandService<Referentiel>>();
