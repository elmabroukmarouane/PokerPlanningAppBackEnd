...
namespace PokerPlanningApp.GenericController
{
        ...
        where TEntityViewModel : Entity
    {
        ...
        public virtual async Task<IActionResult> Get(int id)
        {
            ...
            if (row == null)
            {
                _logger.LoggingMessageWarning("PokerPlanningApp", (int)HttpStatusCode.NotFound, HttpStatusCode.NotFound.ToString(), HttpContext.Request.Method, ControllerContext.RouteData.Values["controller"].ToString(), ControllerContext.RouteData.Values["action"].ToString() + "ById", $"{id}", _currentEnvironment.ContentRootPath);
                return NotFound(new
                {
